...
def main():
    ...
    parser.add_argument(
        ...
        default=0, 
        type=int, 
        help="Epoch number of best epoch from phase 1 used to finetune phase 2 "
    )
    ...
    CHKP = f'EXP_80_RESNET_34_TILES_49_SQ_FT_NBN_SE_DUAL_0_sq_features_{args.phase_1_best_epoch}' 
    ...
    print (f"CHKP : {settings['MODEL_CHECKPOINT_DIR']}/{CHKP}")     
    ...
    learn.fit_one_cycle(args.epoch, max_lr=1e-4, 
